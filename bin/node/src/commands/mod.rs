...
const ENV_NTX_PROVER_URL: &str = "MIDEN_NODE_NTX_BUILDER_NTX_PROVER_URL";
const ENV_RPC_URL: &str = "MIDEN_NODE_RPC_URL";
const ENV_STORE_RPC_URL: &str = "MIDEN_NODE_RPC_STORE_URL";
const ENV_STORE_NTX_BUILDER_URL: &str = "MIDEN_NODE_NTX_BUILDER_STORE_URL";
const ENV_STORE_BLOCK_PRODUCER_URL: &str = "MIDEN_NODE_BLOCK_PRODUCER_STORE_URL";
const ENV_VALIDATOR_BLOCK_PRODUCER_URL: &str = "MIDEN_NODE_BLOCK_PRODUCER_VALIDATOR_URL";
