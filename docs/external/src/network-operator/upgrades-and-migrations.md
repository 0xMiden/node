...
Network upgrades may involve binary upgrades, storage migrations, schema changes, and coordinated service restarts.
...
Upgrade planning should account for RPC schema compatibility, public client expectations, validator availability, NTX
builder compatibility, prover compatibility, and monitoring coverage before the sequencer is restarted.
