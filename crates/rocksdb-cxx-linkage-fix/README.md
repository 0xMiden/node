...
The crate centralizes the C++ standard library linkage configuration needed by crates that build
against RocksDB. It exists to keep that build workaround in one place while the upstream RocksDB
binding behavior is handled externally.
